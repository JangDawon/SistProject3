...
<% 
	...
	String confmKey = "devU01TX0FVVEgyMDIxMDIxNDEzMDk0OTExMDgwMzE="; // 검색API 승인키
...
%>
<script type="text/javascript" src="http://localhost:9000/sistproject3/js/jquery-1.12.4.min.js"></script>
<script type="text/javascript" src="http://localhost:9000/sistproject3/js/addrlink.js"></script>
<link rel="stylesheet" type="text/css" href="http://localhost:9000/sistproject3/css/addrlink.css"></link>
...
<script language="javascript">
	...
	function setParent(){
		...
		opener.jusoCallBack(rtRoadFullAddr);
