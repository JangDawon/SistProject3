...
<body>
	...
	<div class="index_content">
		...
		<section id="today_recommend" class="indexpage_section">
	            <div class="ui_title">
		        ...
		        <div class="outer_frame">
		        	<div class="ui_grid_cols5">
			        	<div class="ui_grid__item">
							<a href="">
								<div class="prod_img">
										<img src="http://localhost:9000/sistproject3/images/또바기.jpg">
								</div>
								<div class="prod_info">
									<div class="prod_info_name">또바기</div>
									<div class="prod_info_title">수제오란다 선물세트</div>
								</div>
								<div class="ui_card_rating">
									...
									<div class="rv">크리스마스 홈파티용 간식으로 구...</div>
								</div>
							</a>
						</div>
						<div class="ui_grid__item">
							<a href="">
								<div class="prod_img">
										<img src="http://localhost:9000/sistproject3/images/모주초콜릿.jpg">
								</div>
								<div class="prod_info">
									<div class="prod_info_name">모주초콜릿</div>
									<div class="prod_info_title">모주,커피,홍차,소주</div>
								</div>
								<div class="ui_card_rating">
									<div class="ui_rating">
										<img src="images/star.png">
									...
									<div class="rv">초콜릿이 완전 작아서 너무 귀여워</div>
								</div>
							</a>
						</div>
						<div class="ui_grid__item">
						...
						<div class="ui_grid__item">
							<a href="">
								...
								<div class="prod_info">
									<div class="prod_info_name">또바기5</div>
									<div class="prod_info_title">수제오란다 선물세트</div>
								</div>
								<div class="ui_card_rating">
									<div class="ui_rating">
				 ...
				 <a href="" class="ui_btn-large">오늘의 발견  더보기</a>
		</section>
